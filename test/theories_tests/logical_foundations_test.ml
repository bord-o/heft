...
let%expect_test "basics" =
  ...
  theorem compute_day_test :
    ...
    theorem test_orb'1 :  eq (orb' true false) true
    theorem test_orb'2 :  eq (orb' false false) false
    theorem test_orb'3 :  eq (orb' false true) true
    theorem test_orb'4 :  eq (orb' true true) true
    theorem test_orb'5 :
        eq
            (orb'
                (orb' false false)
    ...
    theorem test_nandb'1 : eq (nandb' true false) true
    theorem test_nandb'2 : eq (nandb' false false) true
    theorem test_nandb'3 : eq (nandb' false true) true
    theorem test_nandb'4 : eq (nandb' true true) false
    variable a : mybool
  ...
  run_proof (goal "test_orb'1") simp_tac;
  run_proof (goal "test_orb'2") simp_tac;
  run_proof (goal "test_orb'3") simp_tac;
  run_proof (goal "test_orb'4") simp_tac;
  run_proof (goal "test_orb'5") simp_tac;
  run_proof (goal "test_nandb'1") simp_tac;
  run_proof (goal "test_nandb'2") simp_tac;
  run_proof (goal "test_nandb'3") simp_tac;
  run_proof (goal "test_nandb'4") simp_tac;
  ...
  run_proof (goal "andb'_comm") (induct_tac >>> (induct_tac >>> simp_tac));
  run_proof (goal "andb'_true_elim2")
    (induct_tac
    >>> (induct_tac
